...
public class RestConfig extends Application {
    ...
    private void addRestResourceClasses(Set<Class<?>> resources) {
        resources.add(com.api.delivery_service_api.auth.FilterAuthentication.class);
        ...
        resources.add(com.api.delivery_service_api.resource.ProjectPortfolioResource.class);
        ...
        resources.add(com.api.delivery_service_api.resource.TestResource.class);
    }
